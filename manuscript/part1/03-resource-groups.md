...
次の図では、リソースの例として 2 つのサービスの名前を出します。Function App はコードを動かすためのリソースで第14章、Key Vault はパスワードや証明書といった秘密の情報を預けるための保管庫で第16章で扱います。ここでは中身に立ち入らず、リソースグループを跨いで参照し合う 2 つのリソース、という役どころだけ見てください。
